...
class St {
  ...
  manageListeners(e) {
    ...
    }), this.resizeObserver.observe(i.canvas.element)) : O(window, Pt, this.resizeHandler, e)), document && O(document, Ot, this.visibilityChangeHandler, e, !1);
  }
  mouseDown() {
...
class Vt {
  constructor() {
    this.onClick = new Lt(), this.onDiv = new Oe(), this.onHover = new Ht(), this.resize = !0;
  }
  get onclick() {
    return this.onClick;
  }
...
class jt {
  constructor() {
    this.absorb = new $t(), this.bounce = new Fe(), this.enable = !1, this.mode = "bounce", this.overlap = new Xt();
  }
  load(e) {
...
class pi {
  constructor(e, t) {
    this._engine = e, this._container = t, this.bounce = new Fe(), this.collisions = new jt(), this.color = new $(), this.color.value = "#fff", this.groups = {}, this.move = new ni(), this.number = new li(), this.opacity = new ri(), this.reduceDuplicates = !1, this.shadow = new hi(), this.shape = new ci(), this.size = new di(), this.stroke = new Ce(), this.zIndex = new fi();
  }
  load(e) {
    var t, i, s, o, r, l;
    if (!e)
...
class gi {
  ...
  init(e, t, i, s) {
    ...
    ye && (this.sides = ye(this)), this.spawning = !1, this.shadowColor = V(this.options.shadow.color);
...
class _i {
  constructor(e, t) {
    this.container = t, this._engine = e, this.nextId = 0, this.array = [], this.zArray = [], this.pool = [], this.limit = 0, this.needsSort = !1, this.lastZIndex = 0, this.interactionManager = new vi(this._engine, t);
...
class xi {
  constructor(e, t, i) {
    this.id = t, this._engine = e, this.fpsLimit = 120, this.smooth = !1, this._delay = 0, this.duration = 0, this.lifeTime = 0, this._firstStart = !0, this.started = !1, this.destroyed = !1, this._paused = !0, this.lastFrameTime = 0, this.zLayers = 100, this.pageHidden = !1, this._sourceOptions = i, this._initialSourceOptions = i, this.retina = new bi(this), this.canvas = new Ct(this), this.particles = new _i(this._engine, this), this.frameManager = new Tt(this), this.pathGenerators = /* @__PURE__ */ new Map(), this.interactivity = {
      mouse: {
        clicking: !1,
        inside: !1
      }
...
const Li = /* @__PURE__ */ Ei(Ii, [["render", Ai]]), Hi = (n, e) => {
