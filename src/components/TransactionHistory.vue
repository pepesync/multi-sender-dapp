...
const pending = computed(() =>
  transactions.value.some((item) => item.status === 'pending')
);
</script>

<template>
  <div class="card">
    <PaginationList title="List of transactions" :data="transactions">
        ...
        <li class="flex items-center justify-between py-2">
          <div>
            ...
            <a
              ...
              :href="`${environment.explorerUrl}/tx/${item.hash}`"
              target="_blank"
            >
              {{ item.hash }}
            </a>
    ...
    >
      ...
      <span class="text-gray-400">
        Plase wait while fetching the transactions...
      </span>
    </div>

    <Button :disabled="pending" type="primary-alt" @click="reset()">
      Restart
    </Button>
  </div>
</template>
